//! Platform and sandbox executable discovery helpers.
...
/// Detect the current sandbox host platform.
#[must_use]
...
pub(crate) fn command_in_path(command: &str, path_env: Option<&OsStr>) -> bool {
