//! Core image attachment audit API and bounded header reader.
...
use super::dimensions::parse_dimensions;
use super::format::image_format_hint;
use super::routing::image_routing_decision;
