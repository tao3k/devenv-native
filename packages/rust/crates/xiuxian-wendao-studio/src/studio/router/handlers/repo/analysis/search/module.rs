//! Owns the Studio analysis search module surface.
...
use crate::studio::router::handlers::repo::analysis::search::service::typed::run_repo_module_search;
...
) -> Result<Json<xiuxian_wendao::analyzers::ModuleSearchResult>, StudioApiError> {
