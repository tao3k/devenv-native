...
use xiuxian_wendao::search::SearchPlaneCacheTtl;
...
pub(crate) async fn build_intent_search_response_with_metadata(
    ...
    let repo_merge = if code_biased {
        crate::studio::search::handlers::knowledge::merge::build_repo_intent_merge(
            studio,
            raw_query,
            repo_hint,
            candidate_limit,
        ...
        crate::studio::search::handlers::knowledge::merge::RepoIntentMerge::default()
    };
