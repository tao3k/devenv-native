use crate::studio::search::handlers::knowledge::IntentSearchTransportMetadata;
#[cfg(all(test, feature = "duckdb"))]
use crate::studio::search::handlers::knowledge::intent::configured_parquet_query_engine_label;
use crate::studio::types::SearchHit;
use crate::studio::{
    StudioApiError, StudioState, configured_repositories, configured_repository,
    map_repo_intelligence_error,
};
use xiuxian_wendao::search::repo_search::search_repo_intent_outcome;
