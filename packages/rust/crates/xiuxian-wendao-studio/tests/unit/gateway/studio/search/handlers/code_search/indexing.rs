...
async fn publish_all_repo_code_search_indexes(studio: &crate::studio::StudioState) {
    studio
        .repo_index
...
async fn sync_all_repo_code_search_runtime(studio: &crate::studio::StudioState) {
