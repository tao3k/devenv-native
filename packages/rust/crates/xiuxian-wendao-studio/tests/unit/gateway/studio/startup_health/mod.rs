...
fn startup_health_report_requires_all_dependencies_to_be_connected() {
    let report = GatewayStartupHealthReport::new(vec![
        GatewayStartupDependencyCheck::connected("plugins", "plugins=julia-code-parser"),
...
fn startup_health_report_is_ready_when_all_checks_pass() {
    let report = GatewayStartupHealthReport::new(vec![
        GatewayStartupDependencyCheck::connected("plugins", "plugins=julia-code-parser,modelica"),
...
fn describe_gateway_startup_health_includes_status_labels() {
    let report = GatewayStartupHealthReport::new(vec![
        GatewayStartupDependencyCheck {
            ...
            detail: "plugins=julia-code-parser".to_string(),
        },
        GatewayStartupDependencyCheck {
    ...
    assert_eq!(
        lines,
        vec![
            "builtin_plugin_registry=connected plugins=julia-code-parser".to_string(),
