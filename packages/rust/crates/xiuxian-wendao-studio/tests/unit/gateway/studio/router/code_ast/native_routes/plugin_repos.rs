...
-> Result<(), Box<dyn std::error::Error>> {
    crate::studio::search::handlers::tests::linked_parser_summary::ensure_linked_parser_summary_service()?;
...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    xiuxian_wendao::analyzers::analyze_registered_repository_with_registry(
        &repository,
