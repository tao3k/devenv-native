use super::{
    EpistemeCommand, EpistemePlanExtractionRunArgs, EpistemeRunImageOcrCacheArgs,
...
fn episteme_source_contract_run_image_ocr_cache_args_capture_commands() {
    let args = EpistemeRunImageOcrCacheArgs {
        ...
        cache_bridge_script: Some("episteme-repo/tools/run_extraction_plan.py".into()),
