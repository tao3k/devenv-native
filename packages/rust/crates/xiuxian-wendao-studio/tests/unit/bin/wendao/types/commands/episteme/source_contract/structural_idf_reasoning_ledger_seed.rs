...
fn episteme_source_contract_write_reasoning_ledger_seed_args_capture_input_and_limit() {
    let args = EpistemeWriteStructuralIdfReasoningLedgerSeedArgs {
...
fn episteme_source_contract_command_debug_names_reasoning_ledger_seed_variant() {
    let command = EpistemeCommand::SourceContract {
        command: EpistemeSourceContractCommand::WriteStructuralIdfReasoningLedgerSeed(
            EpistemeWriteStructuralIdfReasoningLedgerSeedArgs {
                episteme_root: ".".into(),
    ...
    assert!(rendered.contains("WriteStructuralIdfReasoningLedgerSeed"));
}
