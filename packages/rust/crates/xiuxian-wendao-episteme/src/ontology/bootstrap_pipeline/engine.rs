//! Crate-owned deterministic ontology bootstrap pipeline engine.
...
use crate::{load_episteme_runtime_config, ontology};
...
pub fn run_episteme_ontology_bootstrap_pipeline(
    ...
    run_episteme_ontology_bootstrap_pipeline_impl(request)
}

fn run_episteme_ontology_bootstrap_pipeline_impl(
    request: &EpistemeOntologyBootstrapPipelineRequest,
) -> Result<EpistemeOntologyBootstrapPipelineReport> {
...
pub fn restore_episteme_ontology_bootstrap_pipeline_artifacts(
    ...
    restore_episteme_ontology_bootstrap_pipeline_artifacts_impl(request, cache, options)
}

#[cfg(feature = "foyer-artifact-cache")]
fn restore_episteme_ontology_bootstrap_pipeline_artifacts_impl(
    request: &EpistemeOntologyBootstrapPipelineRequest,
    cache: &(dyn ArtifactBlobCache + Send + Sync),
    options: &EpistemeOntologyBootstrapArtifactCacheOptions,
) -> Result<EpistemeOntologyBootstrapArtifactCacheRestoreReport> {
