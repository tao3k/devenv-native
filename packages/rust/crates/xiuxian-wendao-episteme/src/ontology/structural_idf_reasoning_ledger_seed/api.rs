...
use super::{
    ...
    types::{
        EpistemeOntologyStructuralIdfReasoningLedgerSeedExecutionFlags,
        ...
        EpistemeOntologyStructuralIdfReasoningLedgerSeedSafetyFlags,
...
/// Compile a structural IDF reasoning packet into a fillable Org ledger seed.
///
/// # Errors
///
...
pub fn write_episteme_ontology_structural_idf_reasoning_ledger_seed(
    request: &EpistemeOntologyStructuralIdfReasoningLedgerSeedRequest,
    run_root: impl AsRef<Path>,
) -> Result<EpistemeOntologyStructuralIdfReasoningLedgerSeedReport> {
...
fn build_seed_rows(
    ...
    Vec<EpistemeOntologyStructuralIdfReasoningLedgerSeedRow>,
    usize,
)> {
    ...
    for packet in packet_rows {
        ...
        for seed_kind in [OBJECT_SEED_KIND, RELATION_SEED_KIND] {
...
fn seed_row(
    ...
    EpistemeOntologyStructuralIdfReasoningLedgerSeedRow {
        ...
        execution: EpistemeOntologyStructuralIdfReasoningLedgerSeedExecutionFlags {
            source_text_read: false,
            llm_executed: false,
        },
        safety: EpistemeOntologyStructuralIdfReasoningLedgerSeedSafetyFlags {
...
fn stable_seed_id(run_id: &str, packet_id: &str, seed_kind: &str) -> String {
    ...
    format!("idf.reasoning_ledger_seed.{suffix}")
}
