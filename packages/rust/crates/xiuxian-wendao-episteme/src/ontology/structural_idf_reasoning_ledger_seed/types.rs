...
pub(super) const REASONING_LEDGER_SEED_REPORT_SCHEMA_VERSION: &str =
    "xiuxian_wendao.episteme_structural_idf_reasoning_ledger_seed_report.v1";

/// Request for compiling a reasoning packet into a fillable Org ledger seed.
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct EpistemeOntologyStructuralIdfReasoningLedgerSeedRequest {
    pub(super) reasoning_packet_json: PathBuf,
    pub(super) run_id: String,
    pub(super) limit: usize,
}

impl EpistemeOntologyStructuralIdfReasoningLedgerSeedRequest {
...
pub(super) struct EpistemeOntologyStructuralIdfReasoningLedgerSeedRow {
    pub seed_id: String,
    ...
    #[serde(flatten)]
    pub execution: EpistemeOntologyStructuralIdfReasoningLedgerSeedExecutionFlags,
    #[serde(flatten)]
    pub safety: EpistemeOntologyStructuralIdfReasoningLedgerSeedSafetyFlags,
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningLedgerSeedReport {
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningLedgerSeedExecutionFlags {
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningLedgerSeedSafetyFlags {
