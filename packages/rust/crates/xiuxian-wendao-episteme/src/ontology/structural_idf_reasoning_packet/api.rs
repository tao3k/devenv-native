...
use super::{
    ...
    types::{
        EpistemeOntologyStructuralIdfReasoningPacketExecutionFlags,
        EpistemeOntologyStructuralIdfReasoningPacketReport,
        EpistemeOntologyStructuralIdfReasoningPacketRequest,
        EpistemeOntologyStructuralIdfReasoningPacketSafetyFlags, ReasoningPacketOutputPaths,
        STRUCTURAL_IDF_REASONING_PACKET_REPORT_SCHEMA_VERSION,
    },
    write::{write_json, write_packet_org, write_packet_tsv},
};

/// Compile structural IDF rows into a deterministic Org reasoning packet.
///
/// # Errors
///
/// Returns an error when the structural IDF artifact is missing, malformed,
/// internally inconsistent, filtered to zero rows, or output artifacts cannot
/// be written.
pub fn write_episteme_ontology_structural_idf_reasoning_packet(
    request: &EpistemeOntologyStructuralIdfReasoningPacketRequest,
    run_root: impl AsRef<Path>,
) -> Result<EpistemeOntologyStructuralIdfReasoningPacketReport> {
...
fn build_report(
    ...
    EpistemeOntologyStructuralIdfReasoningPacketReport {
        schema_version: STRUCTURAL_IDF_REASONING_PACKET_REPORT_SCHEMA_VERSION,
        run_id: request.run_id.clone(),
        structural_idf_json: request.structural_idf_json.clone(),
        ...
        execution: EpistemeOntologyStructuralIdfReasoningPacketExecutionFlags {
            source_text_read: false,
            llm_executed: false,
        },
        safety: EpistemeOntologyStructuralIdfReasoningPacketSafetyFlags {
