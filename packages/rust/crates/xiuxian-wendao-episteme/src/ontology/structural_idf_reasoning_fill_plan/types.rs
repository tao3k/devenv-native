...
pub(super) const REASONING_FILL_PLAN_REPORT_SCHEMA_VERSION: &str =
    "xiuxian_wendao.episteme_structural_idf_reasoning_fill_plan_report.v1";

/// Request for compiling a reasoning ledger seed into workflow fill-plan rows.
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct EpistemeOntologyStructuralIdfReasoningFillPlanRequest {
    pub(super) reasoning_ledger_seed_json: PathBuf,
    pub(super) run_id: String,
    pub(super) limit: usize,
}

impl EpistemeOntologyStructuralIdfReasoningFillPlanRequest {
...
pub(super) struct EpistemeOntologyStructuralIdfReasoningFillPlanItem {
    ...
    #[serde(flatten)]
    pub execution: EpistemeOntologyStructuralIdfReasoningFillPlanExecutionFlags,
    #[serde(flatten)]
    pub safety: EpistemeOntologyStructuralIdfReasoningFillPlanSafetyFlags,
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningFillPlanReport {
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningFillPlanExecutionFlags {
...
#[derive(Debug, Clone, Eq, PartialEq, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct EpistemeOntologyStructuralIdfReasoningFillPlanSafetyFlags {
