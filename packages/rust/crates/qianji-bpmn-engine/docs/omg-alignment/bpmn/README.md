...
- non-executable BPMN document snapshots for collaboration, lane, data-object,
  data-store, import, catalog, and category metadata
...
Deferred collaboration, lane, data-object, data-store, import, category, and
unsupported IO surfaces are reported by the linter with explicit repair
guidance instead of being treated as executable runtime semantics.
