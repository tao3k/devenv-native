...
preserve top-level `import`, `itemDefinition`, `message`, `interface`,
`operation`, `resource`, `resourceParameter`, `category`, `categoryValue`,
...
binding, flow-element classification, import resolution, event subscription
