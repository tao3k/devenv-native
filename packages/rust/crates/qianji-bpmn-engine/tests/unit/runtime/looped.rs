use super::{
    StubHost, dmn_fixture_definition, standard_loop_business_rule_process,
    standard_loop_service_process,
};
use crate::test_support::MustExt as _;
use qianji_bpmn_engine::{
    BpmnAdvanceOutcome, BpmnInstanceInit, BpmnPackage, PendingHostWork, PendingHostWorkKind,
    PendingHostWorkResult, ServiceTaskOutcome, advance_instance, apply_pending_host_work_result,
    create_instance,
};
use serde_json::json;
use std::sync::Arc;
