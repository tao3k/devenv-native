use super::{
    StubHost, event_based_gateway_process, exclusive_branch_process,
    parallel_dual_host_block_process, parallel_host_block_process, parallel_join_process,
    parallel_join_same_edge_duplicate_process,
};
use crate::test_support::MustExt as _;
use qianji_bpmn_engine::{
    BpmnAdvanceOutcome, BpmnEngineError, BpmnEventKind, BpmnInstanceInit, BpmnPackage,
    EventPollOutcome, EventPollRequest, PendingHostWorkKind, PendingHostWorkResult,
    ServiceTaskOutcome, WaitKind, advance_instance, apply_event_poll_outcome,
