...
use qianji_bpmn_engine::{
    BpmnEdgeSpec, BpmnEventKind, BpmnEventSpec, BpmnNodeKind, BpmnNodeSpec, BpmnProcessSpec,
    BpmnRepeatSpec, BpmnSequentialMultiInstanceSpec, BpmnTimerKind, BpmnTimerSpec, ProcessKey,
};

pub(super) fn sequential_multi_instance_non_interrupting_boundary_process(
    process_id: &str,
) -> BpmnProcessSpec {
    BpmnProcessSpec::new(
