...
pub(crate) use api::{
    ...
    WaitRegistration, advance_instance_impl, apply_event_poll_outcome,
    apply_pending_host_work_result, build_event_poll_request, build_pending_host_work_request,
    build_pending_host_work_requests, clear_parallel_multi_instance_state,
    clear_sequential_multi_instance_state, clear_standard_loop_state,
    complete_parallel_multi_instance_iteration, create_instance_impl,
