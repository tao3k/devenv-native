# xiuxian-julia-core: Map of Content
...
Standardized documentation index for the `xiuxian-julia-core` package.
...
1. `cargo test -p xiuxian-julia-core --lib polyglot` covers the Julia
   polyglot readiness bridge.
2. `cargo test -p xiuxian-julia-core --lib enforce_rust_project_harness_gate`
