//! Compatibility reexports for memory-family Julia compute contracts.
//!
//! Runtime memory adapters live in `xiuxian-julia-runtime`; profile facts live
//! in `xiuxian-polyglot-orchestrator`.

/// Compatibility downcall namespace.
pub mod downcall;

/// Compatibility host staging namespace.
pub mod host;

/// Compatibility transport namespace.
pub mod transport;
...
pub use xiuxian_julia_runtime::wendao::memory::{
    ...
    MEMORY_JULIA_CALIBRATION_SUMMARY_METRICS_COLUMN, MEMORY_JULIA_COMPUTE_CALIBRATION_PROFILE_ID,
    MEMORY_JULIA_COMPUTE_EPISODIC_RECALL_PROFILE_ID, MEMORY_JULIA_COMPUTE_FAMILY_ID,
    MEMORY_JULIA_COMPUTE_GATE_SCORE_PROFILE_ID, MEMORY_JULIA_COMPUTE_MANIFEST_CAPABILITY_ID_COLUMN,
    ...
    MEMORY_JULIA_COMPUTE_MANIFEST_TIMEOUT_SECS_COLUMN, MEMORY_JULIA_COMPUTE_PLAN_TUNING_PROFILE_ID,
    ...
    MEMORY_JULIA_EPISODIC_RECALL_UTILITY_SCORE_COLUMN, MEMORY_JULIA_GATE_SCORE_CONFIDENCE_COLUMN,
    MEMORY_JULIA_GATE_SCORE_CURRENT_STATE_COLUMN, MEMORY_JULIA_GATE_SCORE_FAILURE_RATE_COLUMN,
    ...
    MemoryJuliaCalibrationArtifactRow, MemoryJuliaCalibrationRequestRow,
    MemoryJuliaComputeManifestRow, MemoryJuliaComputeProfile, MemoryJuliaEpisodicRecallRequestRow,
    MemoryJuliaEpisodicRecallScoreRow, MemoryJuliaGateScoreRecommendationRow,
    MemoryJuliaGateScoreRequestRow, MemoryJuliaPlanTuningAdviceRow,
    MemoryJuliaPlanTuningRequestRow, build_memory_julia_calibration_request_batch,
    ...
    build_memory_julia_episodic_recall_request_batch, build_memory_julia_gate_score_request_batch,
    build_memory_julia_plan_tuning_request_batch, decode_memory_julia_calibration_artifact_rows,
    decode_memory_julia_compute_manifest_rows, decode_memory_julia_episodic_recall_score_rows,
    decode_memory_julia_gate_score_recommendation_rows,
    decode_memory_julia_plan_tuning_advice_rows, fetch_memory_julia_calibration_artifact_rows,
    fetch_memory_julia_episodic_recall_score_rows,
    fetch_memory_julia_gate_score_recommendation_rows, fetch_memory_julia_plan_tuning_advice_rows,
    memory_julia_calibration_request_schema, memory_julia_calibration_response_schema,
    memory_julia_compute_manifest_response_schema, memory_julia_episodic_recall_request_schema,
    memory_julia_episodic_recall_response_schema, memory_julia_gate_score_request_schema,
    memory_julia_gate_score_response_schema, memory_julia_plan_tuning_request_schema,
    memory_julia_plan_tuning_response_schema, process_memory_julia_compute_flight_batches,
    process_memory_julia_compute_flight_batches_for_runtime,
    validate_memory_julia_calibration_request_batch,
    ...
    validate_memory_julia_gate_score_request_batch,
