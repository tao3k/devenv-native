...
pub(crate) fn modelica_parser_summary_timeout_secs_for_repository(
    ...
    Ok(binding
        .endpoint
        .timeout_secs
        .unwrap_or(default_modelica_parser_summary_timeout_secs()))
}

fn default_modelica_parser_summary_timeout_secs() -> u64 {
...
fn build_parser_summary_flight_transport_binding(
    ...
    let timeout_secs = match options.timeout_secs {
        ...
        None => default_modelica_parser_summary_timeout_secs(),
    };
