//! Flight and gRPC transport facade for Wendao.
...
pub use query_contract::{
    ...
    ANALYSIS_REPO_SYNC_ROUTE, ANALYSIS_SEMANTIC_SCOPE_ROUTE,
    DATASET_ONTOLOGY_HANDOFF_SCHEMA_VERSION, DOCUMENT_EXTRACT_FAST_TEXT_PROFILE,
    ...
    DocumentExtractMode, DocumentExtractSourcePath, DocumentExtractWaitBudgetMs, EntityIdRef,
    GRAPH_NEIGHBORS_DEFAULT_HOPS, GRAPH_NEIGHBORS_DEFAULT_LIMIT, GRAPH_NEIGHBORS_ROUTE,
    GraphNeighborsRequest, ModuleIdRef, NodeIdRef, ONTOLOGY_CANDIDATE_INSPECT_ROUTE,
    ONTOLOGY_CANDIDATE_INSPECTION_SCHEMA_VERSION, ONTOLOGY_DATASET_MATERIALIZE_ROUTE,
    OntologyCandidateInspectionFlightRequest, PageIdRef, QUERY_SQL_ROUTE,
    ...
    RepoSyncMode, RepoSyncRequest, RequestIdRef, SEARCH_ATTACHMENTS_ROUTE,
    ...
    WENDAO_GRAPH_NODE_ID_HEADER, WENDAO_ONTOLOGY_CANDIDATE_INSPECTION_REQUEST_HEADER,
    ...
    WENDAO_SEARCH_QUERY_HEADER, WENDAO_SEARCH_REPO_HEADER, WENDAO_SEMANTIC_SCOPE_OBJECT_IDS_HEADER,
    WENDAO_SEMANTIC_SCOPE_TASK_ID_HEADER, WENDAO_SQL_QUERY_HEADER, WENDAO_VFS_PATH_HEADER,
    decode_dataset_ontology_manifest_header, decode_document_extract_source_path_utf8_hex,
    decode_ontology_candidate_inspection_request_header, encode_dataset_ontology_manifest_header,
    ...
    validate_ontology_candidate_inspection_request, validate_refine_doc_request,
...
pub use server::{
    ...
    AutocompleteFlightRouteResponse, DatasetOntologyMaterializeFlightRouteProvider,
