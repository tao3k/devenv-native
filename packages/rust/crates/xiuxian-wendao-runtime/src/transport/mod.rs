...
pub use query_contract::{
    ...
    ANALYSIS_REPO_SYNC_ROUTE, DATASET_ONTOLOGY_HANDOFF_SCHEMA_VERSION,
    DOCUMENT_EXTRACT_FAST_TEXT_PROFILE, DOCUMENT_EXTRACT_FULL_PROFILE,
    DatasetOntologyFlightManifest, DatasetOntologySourceTablePayload, DocumentExtractFlightRequest,
    DocumentExtractMode, GRAPH_NEIGHBORS_DEFAULT_HOPS, GRAPH_NEIGHBORS_DEFAULT_LIMIT,
    GRAPH_NEIGHBORS_ROUTE, GraphNeighborsRequest, ONTOLOGY_DATASET_MATERIALIZE_ROUTE,
    ...
    WENDAO_GRAPH_NODE_ID_HEADER, WENDAO_PDF_OCR_WORKERS_HEADER, WENDAO_REFINE_DOC_ENTITY_ID_HEADER,
    ...
    WENDAO_VFS_PATH_HEADER, decode_dataset_ontology_manifest_header,
