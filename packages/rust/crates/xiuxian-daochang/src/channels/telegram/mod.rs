...
pub use channel::{
    ...
    TelegramControlCommandPolicy, TelegramSlashCommandPolicy, build_telegram_acl_overrides,
    build_telegram_acl_overrides_from_settings, build_telegram_command_admin_rule,
