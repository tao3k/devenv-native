//! Background job manager state and submission API.
...
pub struct JobManager {
    ...
    pub(super) queue_tx: mpsc::Sender<QueuedJob>,
    pub(super) records: Arc<RwLock<HashMap<String, JobRecord>>>,
    pub(super) next_job_seq: AtomicU64,
    pub(super) job_timeout: Duration,
    pub(super) heartbeat_interval: Duration,
    pub(super) heartbeat_probe_timeout: Duration,
    pub(super) max_queued_age_secs: u64,
    pub(super) max_running_age_secs: u64,
}
...
impl JobManager {
    ...
    pub(super) async fn mark_running(&self, job_id: &str) {
