...
fn generic_compensation_configuration_issue(
    ...
    LintIssue::from_parts(
        ...
        vec![
            ...
            "Make the handler a detached task, serviceTask, scriptTask, userTask, manualTask, or businessRuleTask marked with `isForCompensation=\"true\"`, and connect it with exactly one association from the compensation boundary.".to_string(),
