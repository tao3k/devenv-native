...
use super::xml::{
    find_bounded_gateway_ids, find_gateway_default_span_and_id,
    find_missing_branch_condition_context, find_outgoing_flow_summaries, find_routable_task_spans,
};
...
pub(in crate::lint::bpmn::api) struct InvalidDefaultFlowContext {
    pub(in crate::lint::bpmn::api) default_flow_id: String,
    pub(in crate::lint::bpmn::api) gateway_span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) outgoing_flows: Vec<OutgoingFlowSummary>,
}

pub(in crate::lint::bpmn::api) struct DefaultBranchingContext {
    pub(in crate::lint::bpmn::api) default_flow_id: String,
    pub(in crate::lint::bpmn::api) gateway_span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) outgoing_flows: Vec<OutgoingFlowSummary>,
}

pub(in crate::lint::bpmn::api) struct TaskRoutingViolation {
    pub(in crate::lint::bpmn::api) task_id: String,
    pub(in crate::lint::bpmn::api) task_span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) outgoing_flows: Vec<OutgoingFlowSummary>,
}

#[derive(Clone)]
pub(in crate::lint::bpmn::api) struct OutgoingFlowSummary {
    pub(in crate::lint::bpmn::api) id: String,
    pub(in crate::lint::bpmn::api) has_condition: bool,
}

pub(in crate::lint::bpmn::api) struct MissingBranchConditionContext {
    pub(in crate::lint::bpmn::api) flow_id: String,
    pub(in crate::lint::bpmn::api) target_ref: Option<String>,
    pub(in crate::lint::bpmn::api) flow_span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) duplicate_conditioned_flow_ids: Vec<String>,
    pub(in crate::lint::bpmn::api) duplicate_default_flow_ids: Vec<String>,
}

pub(in crate::lint::bpmn::api) struct GatewayFlowDetail {
    pub(in crate::lint::bpmn::api) id: String,
    pub(in crate::lint::bpmn::api) target_ref: Option<String>,
    pub(in crate::lint::bpmn::api) span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) has_condition: bool,
    pub(in crate::lint::bpmn::api) is_default: bool,
}

pub(in crate::lint::bpmn::api) struct ActiveGatewayFlow {
    pub(in crate::lint::bpmn::api) depth: usize,
    pub(in crate::lint::bpmn::api) id: String,
    pub(in crate::lint::bpmn::api) target_ref: Option<String>,
    pub(in crate::lint::bpmn::api) span: std::ops::Range<usize>,
    pub(in crate::lint::bpmn::api) has_condition: bool,
...
pub(in crate::lint::bpmn::api) fn preferred_default_flow(
...
pub(in crate::lint::bpmn::api) fn find_invalid_default_flow_context(
    contents: &str,
    gateway_id: &str,
...
pub(in crate::lint::bpmn::api) fn find_default_branching_context(
    contents: &str,
    gateway_id: &str,
...
pub(in crate::lint::bpmn::api) fn should_append_source_task_routing_issue(
    error: &BpmnEngineError,
) -> bool {
    matches!(error, BpmnEngineError::UnknownSequenceFlowEndpoint { .. })
}

pub(in crate::lint::bpmn::api) fn should_append_source_gateway_condition_issues(
    error: &BpmnEngineError,
) -> bool {
    !matches!(
        error,
...
pub(in crate::lint::bpmn::api) fn should_append_source_unsupported_condition_issues(
    error: &BpmnEngineError,
) -> bool {
    !matches!(error, BpmnEngineError::InvalidXml { .. })
}

pub(in crate::lint::bpmn::api) fn append_unique_source_issues(
    issues: &mut Vec<LintIssue>,
    candidates: Vec<LintIssue>,
) {
...
pub(in crate::lint::bpmn::api) fn source_issue_group_size(issue: &LintIssue) -> usize {
    issue
        .evidence
        .get("conditions")
...
pub(in crate::lint::bpmn::api) fn source_duplicate_unconditional_gateway_issues(
...
pub(in crate::lint::bpmn::api) fn source_invalid_default_gateway_issues(
    source: &BpmnSourceFile,
) -> Vec<LintIssue> {
    find_bounded_gateway_ids(&source.contents)
        .into_iter()
...
pub(in crate::lint::bpmn::api) fn source_task_routing_issue(
    source: &BpmnSourceFile,
) -> Option<LintIssue> {
...
pub(in crate::lint::bpmn::api) fn find_task_routing_violations(
    contents: &str,
) -> Vec<TaskRoutingViolation> {
...
pub(in crate::lint::bpmn::api) fn task_routing_violations_summary(
...
pub(in crate::lint::bpmn::api) fn task_routing_violations_json(
    violations: &[TaskRoutingViolation],
) -> serde_json::Value {
    json!(
        violations
...
pub(in crate::lint::bpmn::api) fn task_routing_structured_repair(
    violations: &[TaskRoutingViolation],
) -> serde_json::Value {
    json!({
        "schema_version": 1,
