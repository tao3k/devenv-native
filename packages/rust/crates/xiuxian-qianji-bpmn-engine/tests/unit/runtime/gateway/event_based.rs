...
async fn runtime_event_based_gateway_registers_competing_waits() {
    ...
    assert_eq!(
        ...
        Some(xiuxian_qianji_bpmn_engine::EventCompetitionState {
    ...
    assert_eq!(
        ...
        EventPollRequest {
            ...
            waits: vec![
                xiuxian_qianji_bpmn_engine::WaitRegistration {
                ...
                xiuxian_qianji_bpmn_engine::WaitRegistration {
                    ...
                    timer: Some(xiuxian_qianji_bpmn_engine::BpmnTimerSpec::new(
                        xiuxian_qianji_bpmn_engine::BpmnTimerKind::Duration,
                        "PT5M",
                    )),
                    condition_expression: None,
