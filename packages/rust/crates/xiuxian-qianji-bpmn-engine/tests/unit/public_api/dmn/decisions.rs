use super::support::fixture_source;
...
use xiuxian_qianji_bpmn_engine::{
    ...
    DmnKnowledgeRequirementReference, parse_dmn_decision, parse_dmn_decisions, snapshot_dmn_source,
};
...
fn package_unqualified_duplicate_dmn_decision_ref_is_rejected() {
    ...
    assert_eq!(
        ...
        BpmnEngineError::AmbiguousDmnDecisionReference {
            decision_id: ("loan-decision".to_string()).into(),
            source_id: None,
            count: 2,
