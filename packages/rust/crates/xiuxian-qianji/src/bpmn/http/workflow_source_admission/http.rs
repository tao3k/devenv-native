use super::compile::{
    MARKDOWN_MEDIA_TYPE, WorkflowSourceCompileError, compile_markdown_workflow_source,
};
...
) -> Result<super::compile::WorkflowSourceCompilation, QianjiBpmnWorkflowHttpError> {
...
fn normalize_authoring_media_type(
    media_type: &str,
) -> Result<&'static str, QianjiBpmnWorkflowHttpError> {
