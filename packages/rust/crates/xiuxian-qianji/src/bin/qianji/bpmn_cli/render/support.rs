...
pub(super) fn bpmn_human_task_form_label(form: &BpmnHumanTaskFormSpec) -> String {
...
pub(super) fn bpmn_human_task_assignment_label(assignment: &BpmnHumanTaskAssignmentSpec) -> String {
