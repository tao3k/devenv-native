...
use xiuxian_qianji::{
    WorkflowPlan, emit_workflow_plan_bpmn, render_workflow_plan_validation_report,
};
...
pub(super) fn run_emit_command(command: &EmitCliCommand) -> io::Result<EmitCliOutput> {
...
pub(super) fn parse_emit_command(args: &[String]) -> io::Result<Option<EmitCliCommand>> {
