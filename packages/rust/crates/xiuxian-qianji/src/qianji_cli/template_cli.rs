...
pub(crate) fn run_template_command(command: &TemplateCliCommand) -> TemplateCliOutput {
...
pub(crate) fn parse_template_command(args: &[String]) -> io::Result<Option<TemplateCliCommand>> {
