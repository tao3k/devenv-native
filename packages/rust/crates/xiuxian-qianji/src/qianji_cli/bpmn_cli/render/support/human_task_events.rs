...
use crate::qianji_cli::bpmn_cli::deps::BpmnHumanTaskLifecycleEvent;

use super::human_task_labels::bpmn_human_task_lifecycle_event_kind_label;
use super::labels::bpmn_pending_host_work_kind_label;

pub(in crate::qianji_cli::bpmn_cli::render) fn append_bpmn_human_task_lifecycle_event_summary(
    rendered: &mut String,
