pub(super) const DEFAULT_MODEL: &str = "MiniMax-M2.5";
pub(super) const DEFAULT_BASE_URL: &str = "http://localhost:3002/v1";
pub(super) const DEFAULT_API_KEY_ENV: &str = "MINIMAX_API_KEY";
