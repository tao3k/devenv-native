...
#[path = "link_graph/addressing/mod.rs"]
pub mod addressing;
#[path = "link_graph/agentic/mod.rs"]
pub mod agentic;
#[path = "link_graph/context_snapshot.rs"]
mod context_snapshot;
#[path = "link_graph/index.rs"]
mod index;
#[path = "link_graph/models/mod.rs"]
mod models;
#[path = "link_graph/narrator.rs"]
mod narrator;
...
#[path = "link_graph/saliency/mod.rs"]
pub mod saliency;
#[path = "link_graph/stats_cache/mod.rs"]
mod stats_cache;
