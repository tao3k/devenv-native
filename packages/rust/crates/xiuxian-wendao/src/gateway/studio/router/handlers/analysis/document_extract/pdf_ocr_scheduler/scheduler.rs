...
use super::super::pdf_ocr_cache::{PdfOcrShardCache, ocr_shard_cache_key};
use super::super::pdf_ocr_order::order_ocr_results_by_inputs;
use super::capacity::{
    OcrCapacityController, OcrSchedulerLane, classify_ocr_lane,
    source_range_override_from_environment,
};
use super::inflight::{InFlightShardEntry, InFlightShardRegistry, InFlightShardReservation};
use super::metrics::{PdfOcrSchedulerMetrics, PdfOcrSchedulerSnapshot};
...
#[derive(Debug)]
pub(in super::super) struct PdfOcrWorkerScheduler {
    permits: Arc<Semaphore>,
    worker_limit: usize,
    capacity: OcrCapacityController,
    cache: PdfOcrShardCache,
    inflight: InFlightShardRegistry,
    metrics: PdfOcrSchedulerMetrics,
}
...
impl PdfOcrWorkerScheduler {
    pub(in super::super) fn from_environment() -> Self {
        Self::with_limit(pdf_ocr_worker_limit())
    }

    pub(in super::super) fn with_limit(worker_limit: usize) -> Self {
    ...
    pub(in super::super) fn snapshot(&self) -> PdfOcrSchedulerSnapshot {
    ...
    #[cfg(test)]
    pub(in super::super) fn permits_for_tests(&self) -> Arc<Semaphore> {
        Arc::clone(&self.permits)
    }

    pub(in super::super) async fn request_shards(
        &self,
        endpoint_url: String,
