...
use super::candidates::{
    agentic_pair_priority, collect_agentic_expansion_candidates, has_direct_edge,
};
use super::workers::partition_expansion_workers;

pub(in crate::link_graph::index::agentic_expansion) fn agentic_expansion_plan_with_config(
