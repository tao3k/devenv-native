...
metadata:
  retrieval:
    ...
    decay_rate: 0.05
  version: "1.0.0"
  source: "https://github.com/tao3k/xiuxian-artisan-workshop/tree/main/packages/rust/crates/xiuxian-wendao/resources/zhixing/skills/forge-evolution"
  routing_keywords:
    - "forge"
    - "evolution"
    - "persona synthesis"
...
This skill implements the **Evolution Trinity** for autonomous capability upgrades from failure traces.
