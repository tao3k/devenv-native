...
fn sample_examples() -> Vec<ExampleRecord> {
    vec![ExampleRecord {
        repo_id: "demo".to_string().into(),
...
fn sample_docs() -> Vec<DocRecord> {
    vec![
        ...
        DocRecord {
            repo_id: "demo".to_string().into(),
            doc_id: "repo:demo:doc:Controllers/UsersGuide/ReleaseNotes.mo#section.Version_4_1_0"
                .into(),
            title: "Version 4.1.0".to_string(),
            path: "Controllers/UsersGuide/ReleaseNotes.mo#section.Version_4_1_0"
                .to_string()
                .into(),
...
fn sample_relations() -> Vec<RelationRecord> {
    vec![
        RelationRecord {
            repo_id: "demo".to_string().into(),
            source_id: "repo:demo:doc:Controllers/UsersGuide/Tutorial/FirstSteps.mo".to_string(),
            target_id: "repo:demo:module:Demo.Controllers".to_string(),
            kind: RelationKind::Documents,
        },
        RelationRecord {
            repo_id: "demo".to_string().into(),
            source_id: "repo:demo:doc:Controllers/UsersGuide/ReleaseNotes.mo#section.Version_4_1_0"
                .to_string(),
            target_id: "repo:demo:module:Demo.Controllers".to_string(),
            kind: RelationKind::Documents,
        },
