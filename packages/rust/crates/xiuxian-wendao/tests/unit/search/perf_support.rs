...
fn repo_content_parquet_mutation_benchmark_reports_1k_and_10k_samples() {
    ...
    print_repo_content_parquet_mutation_benchmark_snapshot(&small_snapshot);
    print_repo_content_parquet_mutation_benchmark_snapshot(&large_snapshot);
    println!(
...
#[cfg(feature = "performance")]
fn print_repo_content_parquet_mutation_benchmark_snapshot(
    snapshot: &RepoContentParquetMutationBenchmarkSnapshot,
) {
    println!(
        ...
        snapshot.changed_document_count,
        snapshot.deleted_path_count,
        snapshot.touched_partition_count,
        snapshot
            .publish_profile
            .mutation_write
        ...
        snapshot.touched_base_document_count,
        snapshot.touched_base_documents_by_partition,
        snapshot.row_count,
        ...
        snapshot
            ...
            .as_secs_f64()
            * 1_000.0,
        snapshot.publish_profile.plan_elapsed.as_secs_f64() * 1_000.0,
        snapshot
            .publish_profile
            .mutation_write
        ...
        snapshot
            ...
            .as_secs_f64()
            * 1_000.0,
        snapshot.publish_profile.finalize.prewarm.as_secs_f64() * 1_000.0,
        snapshot
            .publish_profile
            .finalize
            .record_publication
