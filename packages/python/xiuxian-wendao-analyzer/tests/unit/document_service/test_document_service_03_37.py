...
def test_docling_pdf_ocr_worker_reports_missing_openrouter_key(
    ...
    monkeypatch.delenv(HOSTED_VLM_OCR_API_KEY_ENV, raising=False)
    monkeypatch.delenv(HOSTED_VLM_OCR_OPENROUTER_API_KEY_ENV, raising=False)
    monkeypatch.delenv(HOSTED_VLM_OCR_OPENROUTER_PUBLIC_API_KEY_ENV, raising=False)
