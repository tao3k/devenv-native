...
WENDAO_ROUTE_ID_HEADER = "x-wendao-route-id"
WENDAO_ROUTE_TASK_KIND_HEADER = "x-wendao-route-task-kind"
WENDAO_ROUTE_MODALITY_HEADER = "x-wendao-route-modality"
WENDAO_ROUTE_SELECTED_PROVIDER_HEADER = "x-wendao-route-selected-provider"
WENDAO_ROUTE_SELECTED_MODEL_HEADER = "x-wendao-route-selected-model"
WENDAO_ROUTE_SELECTED_BACKEND_PROFILE_HEADER = "x-wendao-route-selected-backend-profile"
WENDAO_ROUTE_PRECISION_TIER_HEADER = "x-wendao-route-precision-tier"
