...
HOST="$("$PYTHON_BIN" "$PROJECT_ROOT/scripts/channel/resolve_wendao_document_extract_endpoint.py" --config "$CONFIG_PATH" --field host)"
PORT="$("$PYTHON_BIN" "$PROJECT_ROOT/scripts/channel/resolve_wendao_document_extract_endpoint.py" --config "$CONFIG_PATH" --field port)"
