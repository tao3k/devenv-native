...
OPENROUTER_PRIVATE_API_KEY_ENV = "WENDAO_OPENROUTER_API_KEY"
OPENROUTER_PUBLIC_API_KEY_ENV = "OPENROUTER_API_KEY"
OPENROUTER_HOSTED_VLM_API_KEY_ENV = "WENDAO_HOSTED_VLM_OCR_API_KEY"
OPENROUTER_LEGACY_PUBLIC_API_KEY_ENV = "OPENROUTE_API_KEY"
OPENROUTER_STANDARD_API_KEY_ENVS = (
    OPENROUTER_PRIVATE_API_KEY_ENV,
    OPENROUTER_PUBLIC_API_KEY_ENV,
    OPENROUTER_HOSTED_VLM_API_KEY_ENV,
)
