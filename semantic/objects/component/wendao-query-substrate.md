...
and advisory read-model summaries, catalogs, snapshots, and queries while leaving
canonical truth in repository artifacts. The read-model query surface admits
only one read-only SQL statement per request.
