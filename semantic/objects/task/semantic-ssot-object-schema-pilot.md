...
also exposes a read-only semantic projection refresh plan and an explicit
refresh worker entrypoint that can run one pass or supervised recurring
passes while keeping mutation explicit.
