...
| Agent and tool runtime          | [`xiuxian-daochang`](packages/rust/crates/xiuxian-daochang/README.md), `xiuxian-zhenfa`, `xiuxian-llm`, `xiuxian-executor`, `xiuxian-security`, `xiuxian-sandbox`                                                                                                                                                                                                                                                                                                            | Agent loop, native tool routing, LLM orchestration, execution plumbing, and sandbox/security surfaces.                                              |
...
| Repository and parser substrate | [`xiuxian-git-repo`](packages/rust/crates/xiuxian-git-repo/README.md), `xiuxian-wendao-parsers`, [`xiuxian-ast`](packages/rust/crates/xiuxian-ast/README.md), `xiuxian-testing`                                                                                                                                                                                                                                                                                              | Git/repository access, parser ownership, AST tooling, and repo-local testing gates.                                                                 |
